...
public class ScanFolderOrchestratorTests
{
    ...
    private readonly ScanFolderOrchestrator _subject;
    private readonly Mock<ILogger<ScanFolderOrchestrator>> _logger;

    public ScanFolderOrchestratorTests()
    {
        ...
        _logger = new Mock<ILogger<ScanFolderOrchestrator>>();

        _subject = new ScanFolderOrchestrator(_fileSystemService.Object, _fileMetadataRepository.Object,
    ...
    public void ScanFolder_NewPath_ReturnsCorrectData()
    {
        ...
        var expectedResult = new ScanFolderModel
        {
    ...
    public void ScanFolder_SamePath_UpdatesMetadata()
    {
        ...
        var modifiedFile = new ModifiedFileModel { FullName = "modifiedFile", Type = ModifiedFileType.Modified };
